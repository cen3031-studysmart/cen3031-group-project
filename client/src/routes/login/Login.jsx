    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">StudyBuddy AI</CardTitle>
          <CardDescription>
            Empower your learning with AI-powered technology
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <Button variant="outline" className="w-full">
                ...
                >
                  ...
                  <path
                    fill="#4CAF50"
                    d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.026C9.505,39.556,16.227,44,24,44z"
                  />
                  <path
                    fill="#1976D2"
